...
export default {
  data () {
    return {
      ...
      photo : null,
      navs : [{ label : 'Home', iconname : 'home', href : '/client' },
              { label : 'Plat', iconname : 'fastfood', href : '/client/plat' },
              { label : 'Commande', iconname : 'assignment', href : '/client/commande' }]
    }
  },
  mounted (){
  ...
  methods : {
    ...Vuex.mapActions(['edit_token', 'destroy_commande', 'add_profils']),
    logout (){
      this.edit_token('')
